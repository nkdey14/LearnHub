		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
		    <ul class="navbar-nav">
		      <li class="nav-item active">
		        <a class="nav-link" href="showCourseInfo">Learner Details<span class="sr-only"></span></a>
		      </li>
		      <li class="nav-item active">
		        <a class="nav-link" href="showBillingInfo">Billing Details<span class="sr-only"></span></a>
		      </li>
		    </ul>
		  </div>
		</nav>
